#ifndef __VAL_HELPER_H__
#define __VAL_HELPER_H__
...
#define LIBDFT_CALL_ORDER CALL_ORDER_DEFAULT

#define CALL(fn)                                                               \
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                    IARG_THREAD_ID, IARG_CALL_ORDER, LIBDFT_CALL_ORDER + 10, IARG_END)

#define R_CALL(fn, dst)                                                        \
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                    IARG_THREAD_ID, IARG_UINT32, REG_INDX(dst), IARG_CALL_ORDER, LIBDFT_CALL_ORDER + 10, IARG_END)

#define M_CALL_W(fn)                                                           \
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                    IARG_THREAD_ID, IARG_MEMORYWRITE_EA, IARG_CALL_ORDER, LIBDFT_CALL_ORDER + 10,IARG_END)
#define M_CALL_R(fn)                                                           \
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                    IARG_THREAD_ID, IARG_MEMORYREAD_EA, IARG_CALL_ORDER, LIBDFT_CALL_ORDER + 10, IARG_END)

#define R2R_CALL(fn, dst, src)                                                 \
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                    IARG_THREAD_ID, IARG_UINT32, REG_INDX(dst), IARG_UINT32,      \
                    REG_INDX(src), IARG_CALL_ORDER, LIBDFT_CALL_ORDER + 10, IARG_END)
...
#define M2R_CALL(fn, dst)                                                      \
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                    ...
                    IARG_MEMORYREAD_EA, IARG_CALL_ORDER, LIBDFT_CALL_ORDER + 10, IARG_END);
...
#define RR2R_CALL(fn, dst, src1, src2)                                         \
    INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                    IARG_THREAD_ID, IARG_UINT32, REG_INDX(dst), IARG_UINT32,      \
                    REG_INDX(src1), IARG_UINT32, REG_INDX(src2), IARG_CALL_ORDER, LIBDFT_CALL_ORDER + 10, IARG_END)
